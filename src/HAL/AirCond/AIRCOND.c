...
for(;Il<1001;){// read the temprature 1000 times to make sure no error in reading as much as possiple
...
TEMP_senseor_readingavg=TEMP_senseor_readingavg/1000.00;// take average
